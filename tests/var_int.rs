...
// I think it's enough to test only VarInt writing & reading here, as both VarInt and VarLong are
// generated by macros. If the algorithm is okay for VarInt, it should be also okay for VarLong.
